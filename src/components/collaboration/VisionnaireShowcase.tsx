...
const showcaseItems = [
  {
    ...
    image: 'https://res.cloudinary.com/dnddesigncenter/image/upload/v1740571207/1_fpnhab.avif',
    bgColor: '#c4b9a8'
  },
  {
    title: '2023 Collection',
    description: 'Timeless elegance redefined',
    image: 'https://res.cloudinary.com/dnddesigncenter/image/upload/v1740571204/2_j3vyvq.avif',
    bgColor: '#cdc9c6'
  },
  {
    title: '2022 Collection',
    description: 'Where tradition meets innovation',
    image: 'https://res.cloudinary.com/dnddesigncenter/image/upload/v1740571202/3_iyxtvw.avif',
    bgColor: '#ccb2a5'
  },
  {
    title: '2021 Collection',
    description: 'The foundation of modern luxury',
    image: 'https://res.cloudinary.com/dnddesigncenter/image/upload/v1740571205/4_zw7law.avif',
    bgColor: '#424f58'
  },
];
      ...
      <div className="relative bg-white">
        ...
        >
          {showcaseItems.map((item, index) => (
            <div key={index} className="flex items-center px-6 md:px-12 lg:px-16">
              <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                >
                  <h3 className="text-3xl md:text-4xl font-serif text-white">{item.title}</h3>
                  <p className="text-white-600 text-base md:text-lg text-white">{item.description}</p>
                  <a 
