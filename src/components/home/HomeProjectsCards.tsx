...
const projectOptions: ProjectOption[] = [
  {
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/1_converted_abtrac.avif',
    hasContent: true,
  },
  {
    id: 2,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/2_converted_dvxxxk.avif',
    hasContent: true,
  },
  {
    id: 3,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/3_converted_uc7sxw.avif',
    hasContent: true,
  },
  {
    id: 4,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/4_converted_z4arig.avif',
    hasContent: true,
  },
  {
    id: 5,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/5_converted_d2v3em.avif',
    hasContent: true,
  },
  {
    id: 6,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/6_converted_r36ncb.avif',
    hasContent: true,
  },
  {
    id: 7,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/7_converted_e3j2zg.avif',
    hasContent: true,
  },
  {
    id: 8,
    ...
    image:
      'https://res.cloudinary.com/dnddesigncenter/image/upload/v1739789546/Untitled_design_wvbz0p.avif',
    hasContent: true,
  },
];
